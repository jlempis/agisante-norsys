...
(function ($) {
    ...
    var options = {
            ...
            minChar: 8,
            errorMessages: {
                password_to_short: "Le mot de passe devrait comporter au moins 8 caractères",
                same_as_username: "Le mot de passe ne devrait pas être contenir l'identifiant"
            },
            scores: [17, 26, 40, 50],
            verdicts: ["Très faible", "Faible", "Correct", "Fort", "Très fort"],
            showVerdicts: true,
            raisePower: 1.4,
            usernameField: "#utilisateur_username",
            onLoad: undefined,
            onKeyUp: undefined,
            viewports: {
                progress: undefined,
        ...
        setProgressBar = function ($el, score) {
            ...
            if (score < options.scores[0]) {
                progressbar.find(".progress-bar").addClass("progress-bar-danger").removeClass("progress-bar-warning").removeClass("progressbar-bar-success");
        ...
        progressWidget = function () {
            return '<div id="progressbar" class="progress progress-stripped"><div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div></div>';
        },
